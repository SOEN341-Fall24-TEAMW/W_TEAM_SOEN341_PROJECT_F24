...
describe("InstructorDashboard", ()=>{
    ...
    it("teams tab takes you to team page ", async ()=>{
        ...
        render(
            <MantineProvider withGlobalStyles withNormalizeCSS>
            <MemoryRouter >
            <InstructorDashboard organizations={mockOrganizations}
              />
            </MemoryRouter>
            </MantineProvider>
            );
...
<MantineProvider withGlobalStyles withNormalizeCSS>
<MemoryRouter >
<InstructorDashboard organizations={mockOrganizations} courses={mockcourse}
  />
</MemoryRouter>
</MantineProvider>
);
...
<MantineProvider withGlobalStyles withNormalizeCSS>
<MemoryRouter >
<InstructorDashboard organizations={mockOrganizations} courses={mockcourse} teamData ={mockTeamData}
  />
</MemoryRouter>
</MantineProvider>
);
...
<MemoryRouter >
<InstructorDashboard organizations={mockOrganizations} courses={mockcourse} teamData ={mockTeamData} students={mockstudents}
memberships={mockmembership} team={mockteam}  rows2={mockrows2}
  />
</MemoryRouter>
</MantineProvider>
);
